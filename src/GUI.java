...
public void paintComponent(Graphics gg) {
    ...
    drawRooms(g, playerRoom);

}

public void drawRooms(Graphics2D g, int playerRoom) {
    ...
    //colour the room where the player currently is in pink
...
int[][] tunnels = {{2, 5, 8}, {1, 3, 10}, {2, 4, 12}, {3, 5, 14}, {1, 4, 6},
